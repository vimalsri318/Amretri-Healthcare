...
import heroImg from "@/assets/inventory-stock-control-hero.jpg";
...
function InventoryPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    await submitToGoogleSheets("inquiry", {
      formSource: "Inventory & Stock Control Page",
      ...form
    });
            ...
            <div className="lg:col-span-6 xl:col-span-5">
              <Reveal variant="right" className="relative mx-auto max-w-lg lg:max-w-none">
                ...
                <div className="relative overflow-hidden rounded-3xl border border-border shadow-2xl aspect-[3/2]">
                  <img src={heroImg} alt="Hospital pharmacy inventory and stock control services" className="h-full w-full object-cover" />
