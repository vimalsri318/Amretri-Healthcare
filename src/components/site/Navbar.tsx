  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-40">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 text-white">
        <Link to="/" className="flex items-center gap-2 rounded-full bg-white px-4 py-2 shadow-sm">
          <img src={logoAsset} alt="Amretri Healthcare" className="h-7 w-auto md:h-8" />
        </Link>
