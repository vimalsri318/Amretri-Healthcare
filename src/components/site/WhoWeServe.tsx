...
import multispecialty from "@/assets/serve-multispecialty.jpg";
...
const partners = [
  ...
  { img: multispecialty, title: "Multispecialty Hospitals", body: "End-to-end pharmacy, pathology lab and radiology solutions eliminating pilferage, expiry, and compliance gaps." },
];
