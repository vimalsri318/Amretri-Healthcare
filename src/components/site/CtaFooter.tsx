      ...
      <section id="contact" className="relative overflow-hidden bg-brand-deep py-24 text-white md:py-28">
        ...
        <Reveal variant="scale" className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <a
            ...
            className="mt-10 inline-flex items-center gap-3 rounded-full bg-orange py-3 pl-6 pr-3 text-sm font-bold text-white transition hover:bg-orange/95 hover:scale-105 shadow-lg shadow-orange/20"
          >
            Start a Conversation
            <span className="grid h-9 w-9 place-items-center rounded-full bg-white text-orange">
              <ArrowUpRight className="h-4 w-4" />
            </span>
          </a>
        </Reveal>
      </section>      <footer className="bg-footer text-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-12">
          <div className="md:col-span-4">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              ].map(({ Icon, href, label, ...props }) => (
                <a
                  key={label}
                  href={href}
                  aria-label={label}
                  {...props}
                  className="grid h-10 w-10 place-items-center rounded-full bg-accent text-footer transition hover:text-orange hover:scale-110 shadow-sm"
                >
          ...
          <div className="md:col-span-5">
            ...
            <div className="mt-5 text-sm text-white">
              ...
              <div className="mt-5 space-y-2">
                <a href="mailto:info@amretrihealthcare.com" className="flex items-center gap-2 text-accent hover:text-orange hover:underline transition-colors">
                  <Mail className="h-4 w-4" />
                  <span>info@amretrihealthcare.com</span>
                </a>
                <a href="tel:+918585002020" className="flex items-center gap-2 text-accent hover:text-orange hover:underline transition-colors">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-emerald-300 hover:text-orange hover:underline transition-colors font-semibold"
                >
                  <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
                    <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.73-1.455L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.42 9.864-9.864.002-2.637-1.03-5.114-2.904-6.99C16.246 3.75 13.775 2.717 11.14 2.717 5.708 2.717 1.284 7.14 1.28 12.582c-.001 1.776.467 3.51 1.358 5.053l-.832 3.036 3.123-.817zm11.911-7.228c-.302-.15-1.785-.882-2.062-.982-.277-.1-.478-.15-.679.15-.2.3-.777.982-.953 1.185-.175.2-.351.224-.653.075-.302-.15-1.274-.469-2.427-1.496-.897-.8-1.502-1.787-1.678-2.088-.176-.3-.019-.462.132-.612.135-.135.302-.35.453-.525.15-.175.2-.3.302-.5.101-.2.05-.375-.025-.526-.075-.15-.679-1.635-.93-2.24-.244-.589-.493-.51-.679-.519-.176-.009-.377-.01-.578-.01-.201 0-.528.075-.804.375-.276.3-1.055 1.031-1.055 2.516s1.08 2.982 1.23 3.182c.15.2 2.126 3.246 5.15 4.553.719.311 1.28.498 1.718.638.723.23 1.381.198 1.902.12.58-.087 1.785-.73 2.036-1.433.252-.702.252-1.303.176-1.43-.076-.127-.277-.202-.578-.352z"/>
                  </svg>
        ...
        <div className="bg-brand-deep py-6 text-center text-xs text-white/80 border-t border-white/10">
          <div className="mx-auto max-w-7xl px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <Link to="/privacy-policy" className="hover:text-orange hover:underline transition-all">Privacy Policy</Link>
              <Link to="/terms-of-service" className="hover:text-orange hover:underline transition-all">Terms of Service</Link>
            </div>
          </div>
        </div>
      </footer>
